                                    ...
                                    <ItemTemplate>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right open" role="menu" aria-labelledby="dLabel">
                                                <li>
                                                    <asp:LinkButton ID="lnkBtn_Download" OnClick="lnkBtn_Download_Click" ToolTip="Download"
                                                        runat="server" Text='<i class="icon-download"> Download</i>'></asp:LinkButton></li>
                                                <li>
                                                    <asp:LinkButton ID="lnkBtn_ViewDetails" OnClick="lnkBtn_ViewDetails_Click" ToolTip="View Details"
                                                        runat="server" Text='<i class="icon-book"> View Details</i>'></asp:LinkButton></li>
                                            </ul>
                                        </div>
                                    </ItemTemplate>
