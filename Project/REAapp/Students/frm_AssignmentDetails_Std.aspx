                        ...
                        <ItemTemplate>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right open" role="menu" aria-labelledby="dLabel">
                                    <li>
                                        <asp:LinkButton ID="lnkBtn_View" OnClick="lnkBtn_View_Click" ToolTip="View" runat="server"
                                    ...
                                    <li>
                                        <asp:LinkButton ID="lnkBtn_Delete" OnClick="lnkBtn_Delete_Click" ToolTip="Delete" runat="server"
